...
class EpaBacktestChart:
    ...
    def _get_epa_fig(self, backtest_trades, backtest_data):
        ...
        b_buy_marker = dict(color=f'rgba(0,200,0,1)', size=15, line={'width': 2, 'color': 'rgba(255,255,255,0.7)'})
        b_sell_marker = dict(color=f'rgba(200,0,0,1)', size=15, line={'width': 2, 'color': 'rgba(255,255,255,0.7)'})
