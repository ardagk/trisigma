...
class PortfolioRepository(ABC):
    ...
    @abstractmethod
    async def update_strategy_allocation(self, portfolio_manager_id, strategy_allocation) -> None:...

    @abstractmethod
    async def get_strategy_allocation_namings(self, portfolio_manager_id) -> None:...

    @abstractmethod
    async def update_strategy_allocation_namings(self, portfolio_manager_id, namings) -> None:...
